    ...
    <>
      ...
      {/* <div>
        <link
          ...
          rel="stylesheet"
        />
        <div className="bg-purple-900 absolute top-0 left-0 bg-gradient-to-b from-gray-900 via-gray-900 to-purple-800 bottom-0 leading-5 h-full w-full "></div>
            ...
            <div className="p-12 bg-white mx-auto rounded-3xl w-96 ">
              ...
              <div className="space-y-6">
                <form onSubmit={submitHandler} className="space-y-6">
                  ...
                  <div className="mt-4">
                    <div className="flex items-center gap-4">
                      <label className="mr-4 text-sm text-slate-500">
                        I am a:
                      </label>
                      <label>
                        <input
...
{/*       
    ...
    <div className="relative min-h-screen flex flex-col sm:justify-center items-center  bg-gray-100 ">
      <div className="relative sm:max-w-sm w-full">
        ...
        <div className="relative w-full rounded-3xl  px-6 py-7 bg-gray-100 shadow-md">
          <label
            htmlFor=""
          ...
          <form method="#" action="#" className="mt-10 py-6">
            <div>
              <input
                type="email"
